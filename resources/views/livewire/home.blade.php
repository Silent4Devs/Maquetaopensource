            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="https://media3.giphy.com/media/5k5vZwRFZR5aZeniqb/giphy.gif?cid=6c09b952nes1imaulyab7v5qip1jwll0y9j6s2m98ys1efx4&ep=v1_gifs_search&rid=giphy.gif&ct=g"
                        ...
                        <ul class="nav nav-pills nav-fill p-0 bg-transparent" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 active " data-bs-toggle="tab" href="javascript:;"
                                    ...
                                    <span class="ms-1">Configuración de ataque</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="javascript:;"
                                    ...
                                    <span class="ms-1">Progreso de ataque</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="javascript:;"
                                    ...
                                    <span class="ms-1">Reporte de ataque</span>
                                </a>
                            </li>
                        </ul>
                    </div>
    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                <h6 class="mb-0">Seleccionar objetivo</h6>
            </div>
